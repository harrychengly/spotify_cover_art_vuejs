          ...
          <v-expansion-panel class="expansionPanel">
            ...
            <v-expansion-panel-content>
              <v-radio-group
                ...
                row
              >
                <v-radio dark label="Dark" value="random-dark"></v-radio>
                <v-radio dark label="Light" value="random-light"></v-radio>
              </v-radio-group>
            </v-expansion-panel-content>
          </v-expansion-panel>
...
export default {
  ...
  computed: {
    ...mapState("home", ["artists", "error", "retrieveArtistsLoading"]),
    bodyBackgroundColor() {
      return {
